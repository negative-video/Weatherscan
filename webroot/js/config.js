...
var apperanceSettings = {
  ...
  // Fallback ticker text only. The lower marquee normally shows headlines
  // from MARQUEE_FEEDS (see .env); these are used when no feed is configured
  // or every feed is unreachable. Set MARQUEE_MESSAGES to override without
  // editing this file.
  marqueeAd: ["You are watching a recreation of the Weatherscan IntelliStar system. Set MARQUEE_FEEDS in your .env to show live headlines here."],
}
